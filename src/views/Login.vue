    ...
    <div class="w-full max-w-xs m-auto bg-sky-100 rounded p-5">
      ...
      <form action="#" @submit.prevent>
        <div class="flex justify-center mt-3">
          <h6 class="text-[#1A2A58] tracking-tight">Login Form</h6>
        </div>
        <div>
          <label class="block mb-2 text-sky-900" for="username">Username</label>
          <input
        ...
        <div>
          <label class="block mb-2 text-sky-900" for="password">Password</label>
          <input
            class="w-full p-2 mb-6 text-sky-900 border-b-2 border-sky-900 outline-none focus:bg-gray-300"
            v-model="password"
            type="password"
      ...
      <footer class="flex mt-5 justify-between">
        ...
        <a
          class="text-sky-900 hover:underline text-sm float-right"
          style="cursor: pointer"
          @click="
            $router.push({
              name: 'signup',
