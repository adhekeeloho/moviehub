...
<template>
  <nav
    class="nav us bg-gray-900 shadow flex flex-wrap items-center justify-between px-5"
  >
    <div class="flex flex-no-shrink items-center mr-6 py-5 text-white">
      <svg
        version="1.1"
        class="rocket"
    ...
    <label
      ...
      for="menu-btn"
    >
      <span class="navicon bg-white flex items-center relative"></span>
    </label>
...
.let {
  ...
  box-shadow: inset 0 -6px 0 0 #09bd80;
}
